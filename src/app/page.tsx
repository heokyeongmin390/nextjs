    ...
    <>
      ...
      <nav className="fixed top-0 w-full z-50 bg-surface/70 backdrop-blur-xl dark:bg-slate-900/70">
        <div className="flex justify-between items-center h-20 px-8 max-w-screen-2xl mx-auto">
          <div className="text-2xl font-bold tracking-tighter text-blue-600 dark:text-blue-400">
            TemplateHub
          </div>
          <div className="hidden md:flex items-center space-x-8">
            <Link
              className="text-blue-600 dark:text-blue-400 font-semibold border-b-2 border-blue-600 pb-1 font-manrope tracking-tight"
              href="#"
            >
              Company
            </Link>
            <Link
              className="text-slate-600 dark:text-slate-400 font-medium pb-1 font-manrope tracking-tight hover:text-blue-500 transition-colors duration-200"
              href="#"
            >
              Marketing
            </Link>
      ...
      <main className="pt-20">
        ...
        <section className="relative overflow-hidden bg-surface py-24 md:py-32">
          <div className="max-w-screen-2xl mx-auto px-8 relative z-10">
            <div className="max-w-3xl">
              <span className="inline-block px-4 py-1.5 mb-6 text-sm font-bold tracking-widest text-primary bg-primary-container/20 rounded-full">
                PREMIUM TEMPLATES
              </span>
              <h1 className="text-5xl md:text-7xl font-extrabold tracking-tighter leading-tight text-on-surface mb-8">
                남우현이랑 <br />
                <span className="text-primary">같은팀 되면</span>탈주 한다.
              </h1>
              <p className="text-xl md:text-2xl text-on-surface-variant leading-relaxed mb-10 max-w-2xl font-light">
                성공적인 온라인 브랜딩의 시작. 각 분야별 최고의 전문가들이
                설계한 12가지 독보적인 디자인을 지금 만나보세요.
              </p>
              <div className="flex flex-wrap gap-4">
                <Link
                  className="px-8 py-4 bg-primary text-on-primary rounded-xl font-bold flex items-center gap-2 hover:shadow-xl hover:shadow-primary/20 transition-all"
                  href="#templates"
                >
                  템플릿 탐색하기
        ...
        {/* Filter Bar */}
        <section
          className="sticky top-20 z-40 bg-surface/80 backdrop-blur-md border-y border-outline-variant/10"
          id="templates"
        >
          <div className="max-w-screen-2xl mx-auto px-8 py-6 flex flex-wrap items-center justify-between gap-6">
            <div className="flex gap-2 overflow-x-auto pb-2 md:pb-0 scrollbar-hide">
              <button className="px-6 py-2 bg-primary text-on-primary rounded-full font-semibold whitespace-nowrap">
                전체보기
              </button>
              <button className="px-6 py-2 bg-surface-container text-on-surface-variant rounded-full font-semibold hover:bg-surface-container-high transition-all whitespace-nowrap">
                회사 소개
              </button>
              <button className="px-6 py-2 bg-surface-container text-on-surface-variant rounded-full font-semibold hover:bg-surface-container-high transition-all whitespace-nowrap">
                마케팅 랜딩
          ...
          <div className="max-w-screen-2xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
              {templates.map((template, index) => (
                <div
                  key={index}
                  className="group bg-surface-container-lowest rounded-3xl overflow-hidden shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-300"
                >
                  <div className="relative aspect-[4/3] overflow-hidden">
                    ...
                    <div className="absolute top-4 left-4">
                      <span
                        className={`px-3 py-1 text-white text-[10px] font-bold rounded uppercase tracking-widest backdrop-blur-sm ${template.tagColor}`}
                      >
                        {template.tag}
                      </span>
                    </div>
                  ...
                  <div className="p-6">
                    ...
                    <Link
                      href={template.href}
                      className="w-full py-3 bg-surface-container-highest text-on-surface font-bold rounded-xl group-hover:bg-primary group-hover:text-on-primary transition-all flex items-center justify-center gap-2"
                    >
                      Preview
        ...
        <section className="bg-primary-container/10 py-24 px-8 text-center">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl md:text-5xl font-extrabold text-on-surface mb-6">
              찾으시는 스타일이 없으신가요?
            </h2>
            <p className="text-lg text-on-surface-variant mb-10">
              귀사만의 특별한 브랜드 정체성을 담은 1:1 맞춤형 템플릿 제작도
              가능합니다.
            </p>
      ...
      <footer className="w-full py-12 bg-slate-50 dark:bg-slate-950">
        <div className="flex flex-col md:flex-row justify-between items-center px-8 max-w-screen-2xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            <Link
              className="font-manrope text-sm text-slate-500 hover:text-slate-900 dark:text-slate-400 dark:hover:text-slate-100 transition-all hover:underline"
              href="#"
            >
              Privacy Policy
            </Link>
...
const templates = [
  ...
  },
  {
    ...
    tagColor: 'bg-blue-500/90',
    image:
      'https://lh3.googleusercontent.com/aida-public/AB6AXuAbDQXMR5aefI3IP9HffZ_Ny9aw727c9sKtSTzBDEbmuFf3CwGeesMiq0RthLXzjHP632KL1TyITpuKtLRPufOT2-4_1U7l8SohmzSGXfuIs_2xQTiNLmHyntyxTShfuqrCo2TQ1DMMGdzpHuwdCGGKhI2WmahbqUSkKeH31_vZFcmHt3_faQIckZBP-BkpuKPkbjFiJrurm4p9BkdoIT3r0U5tHf0WHDebpkCoowjfGKVT5e0D2cc_9rlDDx3rqocHNUDTMi9ti6vL',
  ...
  },
  {
    ...
    tagColor: 'bg-secondary',
    image:
      'https://lh3.googleusercontent.com/aida-public/AB6AXuB3qJ4N2z0C-Y2VsFMhZ28bmM3lwhRVCofK5uSlk8TXPJQV5c1wcxjcpmpACY8EA9wzihq6t8JQnwJFrCVOo2XY0NbkMF5eAWZOcBxFOLM9Qio21cBI8WR0ynk4MEunIFTcMqULj8jLZ6vI5FQKQ7jru0m7FINE9jpt-YQvGEsjDKosqXmkzYni50Uv3g4CZzVPivPvFU61-fWskG5CtlG0T2iGVNYuzgZiD9ZC0M0VVsS-N0VH6u4GEiefZ6ss3_E88188-KBqhDxs',
  ...
  },
  {
    ...
    image:
      'https://lh3.googleusercontent.com/aida-public/AB6AXuDeeIpr96Z4HCqdyC0iULJisjnAWG1u9Cf-fsVgB1x8H9qCImbv1ddxFVH5zvIbzYh8Uw3zmss9LeFjzHuFFTKrzc8DBHtW9Rr3Fyplat-G4P2MEyQJZ35VXGbS87pVjrZA_D3McsvVLUkCX32QLIsX97YCKcT2boSgBjgMsNz-d1Nep0iTX6H5y0DKHsDhuJklkNyeaDus7AggyK66zQ8lUoeDr6e6Ll4C9J-WL4QV1QwDOKiF0HQr6-PJvpMDqHwdc1LHsUCcxTVb',
    href: '/templates/marketing-feature',
  },
  {
    title: '마케팅 랜딩 (원페이지형)',
    description:
      '가장 빠르고 효율적으로 핵심 메시지를 전달하는 단일 페이지입니다.',
    tag: 'Single Page',
    tagColor: 'bg-primary-fixed-dim text-primary',
    image:
      'https://lh3.googleusercontent.com/aida-public/AB6AXuB_0wV33HfzccAmabiq-A0PTonQ61a_9deG4b9Nv00pqOA2zNAYh1LCdG78LcPM0B9COzlMf90tUfU-r1hhejy2Unwlaw0zZzTtxwn8Fe_O8TyDjUVzQ2pBFWq_FkkgADTSLNm7Y4uhVOcHzTKQNkFsssjRPnzh35D5APOW92arH6jyJGgwl0WthB9f6KWQ7F_Q52psV56b5E6brvkmmuQMuxVlyp_ZPLCalFFGUT3XsDkHYAz12vUylLbDFSa2hs_e0mqVy8vnp35N',
  ...
  },
  {
    ...
    tagColor: 'bg-secondary',
    image:
      'https://lh3.googleusercontent.com/aida-public/AB6AXuC72GiR1wdywKRNPmCWSs9B_8iGQU5EsBm4M7Dkqmsh4wYQSXdSxHalZNu03pKYWuQjOZpJC-mVjQBH8KlYmJ2feMj4Cl7Ea99y5hzCB_1xcH4ALy8OryzMCpewaowmUCIrgNGMV0swr_4vABhIHi9kfsGm2hh039MNECrPNvlxSvshu4qzz6WgHTb0raYl2i_2HIbJfEM2f2-a3Wudfa-49JCuejWI8GqSC2famBF_hkHG6qan86KGzyLBFTNt1t6YAVlJGYml0N7k',
  ...
  },
  {
    ...
    tagColor: 'bg-secondary',
    image:
      'https://lh3.googleusercontent.com/aida-public/AB6AXuD9gb0TTeu-VmCSKmHe5mNdIANOOYjiwB5dtOWUyknjXfymonbRj1fQhc2zkSk_HC1M9LSFiOJdnnYwWwG5ac9RE7ZMhObW9u1aP5i2pK_L3eKJ1DfzF71PHwLiG_mqOPUxUBqpKeK3JgdLSYXLRN_xE1QBGtcqk0rp_989_AcAimVFhTosWA_PTrg0-_K-xYC-QHR3qOjaPEFotebKzYmkJkMJzLMAqBwtvlKJaIsjWzGOFuPcilQJT1WQ8qhaVvCqkQMka5FtYA8Y',
    href: '/templates/restaurant-fine',
  },
  {
    title: '음식점 (캐주얼 다이닝)',
    description:
      '누구나 편하게 방문할 수 있는 밝고 활기찬 분위기의 템플릿입니다.',
    tag: 'Casual',
    tagColor: 'bg-tertiary',
    image:
      'https://lh3.googleusercontent.com/aida-public/AB6AXuCUVqHjWYlwdvN_eJylp0YJ6fS5YYJwOCgFkYqQeDmdkVUUgMeELtZk1ivs-yEzzb_CUOARiRBhx_WnuWw2ngE_8Tc4lyGujtdFfVIqwIe6i6jenZdJn38BLua0MIcJBYoOGgju2gY_PjJ5eOrtaO6sV0chD5xAxdUP_BVv-U6YpDzi335_FSIyjgvCPsT-0rVltua55Pobnr18_HfLP6L5yjUyU1ecFfz9qdncwP-6-QPvwub7xf36tnzAJsEDRbHRiF1QixmM7Vzm',
